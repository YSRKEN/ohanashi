...
import { loadImage, fillTextEx, fillZero, getDerepoNameAuto } from 'service/utility';
...
const drawMethodImpl = async (data: DerepoData) => {
  ...
  if (context !== null) {
    ...
    context.fillText(data.name === '' ? getDerepoNameAuto(data) : data.name, 25 + ICON_SIZE + 9, 16);
