...
const InputCharacterIcon: React.FC<{
  ...
  return (
    <FormGroup>
      <FormLabel>アイコン({iconName})</FormLabel>
      <br />
      <div className="d-flex ml-3">
        ...
        <div className="my-auto">
          <Button
            className="mx-3"
            variant="secondary"
            onClick={clickCharaButtonFunc}
          >
            キャラ
          </Button>
          <Button variant="secondary" onClick={clickIconButtonFunc}>
            表情
          </Button>
        </div>
      </div>
      {iconSelectorFlg ? (
        <IconSelector
          ...
          setIconSelectorFlg={setIconSelectorFlg}
        />
      ) : (
        <></>
      )}
